...
p.pose.position.y = 1
p.pose.position.z = 0.3
scene.add_box("Module_plate", p, (0.8, 1.4, 0.18))
...
while True:
    ...
    #remove bolt
        ...
        pose_target.position.z = z+0.27;#-0.55
        target_pub.publish(pose_target)
        ...
        pose_target.orientation.y = 0.5
        pose_target.orientation.z = -0.5
        pose_target.position.x = 0;#+0.25
        pose_target.position.y = 0.2;#-0.8
        pose_target.position.z = 1.1;#-0.55
        target_pub.publish(pose_target)
        ...
        if plan_status==-1:
                ...
                print("failed pose_target world frame:",pose_target)
               #user planner failed, use second resort, moveit planner
